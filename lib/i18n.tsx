...
const translations: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    "nav.team": "团队看板",
    "nav.projects": "项目任务",
    "projects.title": "项目任务板",
    "projects.subtitle": "追踪团队正在进行的项目",
    "projects.new": "新建项目",
    "projects.name": "项目名称",
    "projects.owner": "负责人",
    "projects.create": "创建",
    "projects.cancel": "取消",
    "projects.empty": "暂无项目，点击右上角创建一个",
    "projects.completed": "已完成",
    "projects.members": "位成员",
    "projects.memberName": "成员名称",
    "projects.syncFound": "检测到 {n} 个新任务",
    "projects.syncNone": "没有检测到新任务",
    "projects.addTask": "添加任务...",
    "projects.inProgress": "进行中",
    "projects.finished": "已完成",
    "projects.noFinished": "还没有完成的任务",
    "nav.daily": "每日动态",
    "daily.title": "每日动态",
    "daily.subtitle": "团队成员每日工作更新",
    "daily.activeAgents": "活跃成员",
    "daily.totalMessages": "消息总数",
    "daily.totalTokens": "Token 总量",
    "daily.highlights": "工作摘要",
    "daily.noActivity": "这一天没有活动记录",
    "team.title": "团队进度",
    "team.active": "活跃",
    "team.idle": "空闲",
    "team.tokens": "Token 消耗",
    "team.messages": "消息数",
    "team.sessions": "会话数",
    "team.responseTime": "平均响应",
  ...
  en: {
    ...
    "projects.title": "Project Board",
    "projects.subtitle": "Track ongoing team projects",
    "projects.new": "New Project",
    "projects.name": "Project name",
    "projects.owner": "Owner",
    "projects.create": "Create",
    "projects.cancel": "Cancel",
    "projects.empty": "No projects yet. Click + to create one.",
    "projects.completed": "done",
    "projects.members": "members",
    "projects.memberName": "Member name",
    "projects.syncFound": "Found {n} new tasks",
    "projects.syncNone": "No new tasks detected",
    "projects.addTask": "Add task...",
    "projects.inProgress": "In Progress",
    "projects.finished": "Finished",
    "projects.noFinished": "No finished tasks yet",
    "nav.daily": "Daily Updates",
    "daily.title": "Daily Updates",
    "daily.subtitle": "Team member daily activity digest",
    "daily.activeAgents": "Active Members",
    "daily.totalMessages": "Total Messages",
    "daily.totalTokens": "Total Tokens",
    "daily.highlights": "Highlights",
    "daily.noActivity": "No activity on this day",
    ...
    "team.responseTime": "Avg Response",
    "team.lastActive": "Last Active",
    "team.trend": "7-Day Trend",
    "team.noData": "No data",
